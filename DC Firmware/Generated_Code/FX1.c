...
**     Date/Time   : 2015-02-26, 10:16, # CodeGen: 33
**     Abstract    :
...
void FX1_RECONFIGURE_RANGE()
{
	GI2C1_WriteByteAddress8(FX1_I2C_ADDR,FX1_CTRL_REG_1,STAND_BY);
	GI2C1_WriteByteAddress8(FX1_I2C_ADDR, FX1_XYZ_DATA_CFG, EIGHT_G);
	GI2C1_WriteByteAddress8(FX1_I2C_ADDR,FX1_CTRL_REG_1,ACTIVE_MODE);
};
